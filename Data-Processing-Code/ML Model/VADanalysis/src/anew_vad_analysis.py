...
##############################################
##############################################
data = pd.read_csv(f'yash-shah-code/Twitter/csvs/{user_id}.csv')
with open(f'yash-shah-code/ML Model/VADanalysis/txts/{user_id}.txt', 'a') as fi:
    for i in data['tweet']:
        fi.write(i)
        fi.write('\n')
##############################################
...
anew = 'yash-shah-code/ML Model/VADanalysis/lib/EnglishShortened.csv'
...
if __name__ == '__main__':
    # get arguments below:
    input_file = f'yash-shah-code/ML Model/VADanalysis/txts/{user_id}.txt'
    #input_file = '../data/emobank_text.txt'
    #input_file = './input.txt'
    input_dir = ''#only for input directory
    mode = 'mean'
    output_dir = 'yash-shah-code/ML Model/VADanalysis/outputs'
