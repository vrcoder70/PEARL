...
anew = '/Users/yashshah/ASU Documents/Fall 22/CSE 578 Data Visualisation/Project/text-vad/VADanalysis/lib/EnglishShortened.csv'
...
if __name__ == '__main__':
    # get arguments below:
    input_file = '/Users/yashshah/ASU Documents/Fall 22/CSE 578 Data Visualisation/Project/text-vad/VADanalysis/src/input.txt'
    #input_file = '../data/emobank_text.txt'
    #input_file = './input.txt'
    input_dir = ''#only for input directory
    mode = 'mean'
    output_dir = 'anew_' + mode
